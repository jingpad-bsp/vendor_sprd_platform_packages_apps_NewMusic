...
public class LRC {
    ...
    public boolean setBasicInfo(String key, String value) {
        if (key != null) {
            ...
            if (LyricConstants.KEY_AR.equals(this.key)) {
                artist = value;
            } else if (LyricConstants.KEY_TI.equals(this.key)) {
                title = value;
            } else if (LyricConstants.KEY_AL.equals(this.key)) {
                album = value;
            } else if (LyricConstants.KEY_BY.equals(this.key)) {
                by = value;
            } else if (LyricConstants.KEY_OFFSET.equals(this.key)) {
                offset = new Long(value);
            } else if (LyricConstants.KEY_KEY.equals(this.key)) {
                this.key = value;
            }
            return true;
        }
