...
public class MediaAppWidgetProvider extends AppWidgetProvider {
    private static final String LOGTAG = "MediaAppWidgetProvider";
    ...
    private void defaultAppWidget(Context context, int[] appWidgetIds) {
        ...
        views.setImageViewResource(R.id.icon, R.drawable.pic_song_default);
    ...
    void performUpdate(MediaPlaybackService service, int[] appWidgetIds, String what, Bitmap bmp) {
        ...
        final RemoteViews views = new RemoteViews(service.getPackageName(), R.layout.widget_small);
...
//        Bitmap bmp = MusicUtils.getArtwork(service, audioId, albumId,false);
        ...
        if (MediaPlaybackService.SERVICE_DESTROY.equals(what)) {
            ...
            views.setImageViewResource(R.id.toggle_btn, R.drawable.widget2_button_play_continue);
        ...
        if (playing) {
            views.setImageViewResource(R.id.toggle_btn, R.drawable.widget2_button_play_halt);
        } else {
            views.setImageViewResource(R.id.toggle_btn, R.drawable.widget2_button_play_continue);
        }
